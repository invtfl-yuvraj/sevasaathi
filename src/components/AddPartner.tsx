    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <div className="bg-red-100 text-red-600 p-3 rounded-md mb-4">Home &gt; Partners &gt; Add</div>
          ...
          <form onSubmit={handleSubmit} className="bg-white p-6 shadow-md rounded-md w-1/2">
            ...
            <button type="submit" className="bg-red-600 text-white px-4 py-2 rounded-md">Add Partner</button>
          </form>
        </main>
      </div>
    </div>
