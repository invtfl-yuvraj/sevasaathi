...
const page = () => {
  return (
    <div className="p-4">
      ...
      <header className="mt-4 text-locationcolor font-sans p-4">
        HELLO 👋 <br></br>
      ...
      <div className="grid grid-cols-4 mt-[5%] ">
        <div className="h-10 w-10 bg-[#FFBC99] rounded-full  flex justify-between items-center flex-col gap-2 p-2 ">
          <Image
            ...
            alt="AC Repair"
          />
          <p className="text-xs">AC Repair</p>
        </div>
        <div className="h-10 w-10 bg-painting rounded-full flex justify-between items-center flex-col gap-2 p-2">
          <Image
            className=""
        ...
        <div className="h-10 w-10 bg-appliance rounded-full flex justify-between items-center flex-col gap-2 p-2">
          <Image
            className=""
